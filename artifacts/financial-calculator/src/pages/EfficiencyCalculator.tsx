...
import { useCalculatorState, EFFICIENCY_EMPTY } from '@/lib/CalculatorStateContext';
...
export function EfficiencyCalculator() {
  ...
  const vals = state.efficiency;
  const setVals = (v: Record<string, string> | ((p: Record<string, string>) => Record<string, string>)) =>
    setCalc('efficiency', typeof v === 'function' ? v(state.efficiency) : v);
        ...
        <div className="order-2 lg:order-1 flex flex-col gap-4">
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-3">
              <button
                onClick={() => setCalc('efficiency', { ...EFFICIENCY_EMPTY })}

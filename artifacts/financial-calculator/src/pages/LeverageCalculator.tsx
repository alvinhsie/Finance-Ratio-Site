                    ...
                    {isInfoOpen && (
                      ...
                      >
                        <div className="px-4 pb-4 pt-1 space-y-3 border-t border-border/50">
                          <span className="inline-flex text-xs font-medium px-2.5 py-0.5 rounded-full bg-orange-50 text-orange-700 border border-orange-200">
                            {language === 'en' ? 'Leverage' : 'Leverage'}
                          </span>
